...
var MonthItem = function (_a) {
    ...
    return (React.createElement("div", { className: "rgc-calendar__year-month", "data-testid": tests_1.testIds.monthItem, onClick: handlerClick }, title));
};
exports.default = React.memo(MonthItem);
