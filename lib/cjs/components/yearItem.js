...
var YearItem = function (_a) {
    ...
    return (React.createElement("div", { className: "rgc-calendar__decade-year", "data-testid": tests_1.testIds.yearItem, onClick: handlerClick }, year));
};
exports.default = React.memo(YearItem);
